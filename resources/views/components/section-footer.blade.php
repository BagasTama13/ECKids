    ...
    <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
            ...
            <div class="flex gap-4 mt-4">
                <a href="https://www.tiktok.com/@englishcafeindonesia" class="hover:opacity-70 transition">
                    <img src="images/tiktok.svg" class="h-6" alt="TikTok">
                </a>
                <a href="https://www.instagram.com/englishcafepusat/" class="hover:opacity-70 transition">
                    <img src="images/instagram.svg" class="h-6" alt="Instagram">
                </a>
                <a href="https://api.whatsapp.com/send/?phone=6285183159961&text=Halo%2C+kak.+Saya+mau+daftar+kursus+di+English+Cafe&type=phone_number&app_absent=0" class="hover:opacity-70 transition">
                    <img src="images/whatsapp.svg" class="h-6" alt="WhatsApp">
                </a>
            </div>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li><a href="#benefit-section" class="hover:text-brand-orange transition">Manfaat</a></li>
                <li><a href="#program-section" class="hover:text-brand-orange transition">Program</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                <li><a href="https://api.whatsapp.com/send/?phone=6285183159961&text=Halo%2C+kak.+Saya+mau+daftar+kursus+di+English+Cafe&type=phone_number&app_absent=0" class="hover:text-brand-orange transition">Pusat Bantuan</a></li>
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm">
                ...
                <li class="flex gap-3 items-center">
                    <img src="/images/telephone.svg" alt="Phone" class="h-5 opacity-90">
                    <a href="tel:+6289627031834" class="hover:text-brand-orange transition">
                        +62 896-2703-1834
                    </a>
                </li>
                ...
                {{-- Email --}}
                <li class="flex gap-3 items-center">
                    <img src="images/email.svg" alt="Email" class="h-5 opacity-90">
                    <a href="mailto:info@englishcafekids.com" class="hover:text-brand-orange transition">
                        info@englishcafekids.com
                    </a>
                </li>
            </ul>
        </div>
